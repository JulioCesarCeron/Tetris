...
@section('content')
    <div class="container">
        @if($breadcrumb == 'create')
            {!! Breadcrumbs::render('admin-avaliacao-create') !!}
        @elseif($breadcrumb == 'edit')
            {!! Breadcrumbs::render('admin-avaliacao-edit', $avaliacao) !!}
        @endif
        <div class="bs-component">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    @if($avaliacao)
                        <form method="POST" action="{{ route('admin.avaliacao.update',['id' => $avaliacao->id])}}" accept-charset="UTF-8">
                        <input name="_method" type="hidden" value="PUT">
                    @else
                        <form method="POST" action="{{url('admin/avaliacao')}}" accept-charset="UTF-8">
                    @endif
